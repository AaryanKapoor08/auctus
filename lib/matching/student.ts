...
function scoreEducationLevel(profile: StudentProfile, item: MatchableFundingItem) {
...
function scoreField(profile: StudentProfile, item: MatchableFundingItem) {
...
function scoreInstitution(profile: StudentProfile, item: MatchableFundingItem) {
...
function scoreProvince(profile: StudentProfile, item: MatchableFundingItem) {
...
function scoreGpa(profile: StudentProfile, item: MatchableFundingItem) {
